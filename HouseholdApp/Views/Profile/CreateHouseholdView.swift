...
struct CreateHouseholdView: View {
    ...
    var body: some View {
        NavigationView {
            Form {
                Section("Haushalt-Details") {
                    TextField("Haushalt-Name", text: $householdName)
                ...
                Section {
                    Text("Du wirst automatisch zum Administrator des neuen Haushalts.")
                        .font(.caption)
                        .foregroundColor(.secondary)
                }
            }
            .navigationTitle("Haushalt erstellen")
