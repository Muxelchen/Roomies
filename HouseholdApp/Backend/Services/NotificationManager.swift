...
class NotificationManager: NSObject, ObservableObject {
    ...
    func scheduleTaskReminder(for task: Task) {
        ...
        content.body = "'\(taskTitle)' ist jetzt fällig!"
    ...
    func scheduleChallengeReminder(for challenge: Challenge) {
        ...
        let content = UNMutableNotificationContent()
        content.title = "Challenge läuft ab"
        content.body = "'\(challengeTitle)' endet bald! Nutze deine letzte Chance."
        content.sound = UserDefaults.standard.bool(forKey: "soundEnabled") ? .default : nil
    ...
    func scheduleLeaderboardUpdate() {
        ...
        let content = UNMutableNotificationContent()
        content.title = "Wöchentliche Bestenliste"
        content.body = "Schau dir deine Position in der neuen Wochenrangliste an!"
        content.sound = UserDefaults.standard.bool(forKey: "soundEnabled") ? .default : nil
