                ...
                ScrollView {
                    LazyVStack(spacing: 16) {
                        ...
                        case .available:
                            ...
                            SampleChallengeCard(
                                title: "Küchenmeister",
                                description: "Halte die Küche 7 Tage lang sauber",
                                points: 100,
                                duration: "7 Tage",
                                difficulty: .medium
                            )
                            ...
                            SampleChallengeCard(
                                title: "Aufräum-Champion",
                                description: "Erledige 20 Aufgaben in einer Woche",
                                points: 150,
                                duration: "1 Woche",
                                difficulty: .hard
                            )
        ...
        VStack(alignment: .leading, spacing: 12) {
            ...
            HStack {
                if isCompleted {
                    ...
                    Label("Abgelaufen", systemImage: "clock.fill")
                        .font(.caption)
                        .foregroundColor(.red)
                } else {
                ...
                Text("\(challenge.participants?.count ?? 0) Teilnehmer")
                    .font(.caption)
                    .foregroundColor(.secondary)
            }
        }
...
struct EmptyChallengesView: View {
    ...
    private var title: String {
        switch type {
        case .active: return "Keine aktiven Challenges"
        case .completed: return "Noch keine Challenges abgeschlossen"
        case .available: return "Neue Challenges verfügbar"
        }
    }
    
    private var message: String {
        switch type {
        case .active: return "Trete einer Challenge bei und fordere deine Mitbewohner heraus!"
        case .completed: return "Schließe deine ersten Challenges ab und sammle Belohnungen!"
        case .available: return "Wähle eine Challenge aus und starte den Wettkampf!"
        }
    }
}
